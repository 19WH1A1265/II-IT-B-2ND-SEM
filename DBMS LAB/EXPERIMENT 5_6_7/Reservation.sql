DROP DATABASE IF EXISTS `19wh1a1265_ticket_reservation`;
CREATE SCHEMA 19wh1a1265_ticket_reservation;
USE 19wh1a1265_ticket_reservation;
...
INSERT INTO pasangers(pid, name, phone_number, gender, address, age) VALUES(1, 'Bharani', 1234567890, 'F', 'Siddipet', 19);
INSERT INTO pasangers VALUES(2, 'Akhil', '9876543210', 'Andhra', 'M', 18),(6,'xyz','0000000000','hyd','M',22);
INSERT INTO pasangers VALUES(3, 'Pooja', '1357924680', 'Hyderabad', 'F', 19);
INSERT INTO pasangers VALUES(4, 'Chinna', '1111111111', 'vizag', 'M', 23),(7,'rabch','1234521234','Nirmal','M',40);
INSERT INTO pasangers VALUES(5, 'Jhanavi', '2222222222', 'Karimnagar', 'F', 14);
